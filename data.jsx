...
const HOJE_BANNER = [
  {
    id: 'h1', kind: 'premio', accent: 'olive',
    headline_pt: 'Booker Prize 2026: longlist com 13 romances anunciada',
    headline_en: 'Booker Prize 2026: longlist of 13 novels announced',
    sub_pt: 'Marlon James, Douglas Stuart e Elizabeth Strout entre os indicados. Shortlist em 22 de setembro.',
    sub_en: 'Marlon James, Douglas Stuart and Elizabeth Strout among the nominees. Shortlist on September 22.',
  },
  {
    id: 'h2', kind: 'efemeride', accent: 'terra',
    headline_pt: '6 de agosto · Jorge Amado morre em Salvador (2001)',
    headline_en: 'August 6 · Jorge Amado dies in Salvador (2001)',
    sub_pt: 'Há 25 anos, o Brasil perdia seu romancista mais traduzido — presente hoje em 49 idiomas.',
    sub_en: 'Twenty-five years ago, Brazil lost its most translated novelist — now read in 49 languages.',
  },
  {
    id: 'h3', kind: 'efemeride', accent: 'ochre',
    headline_pt: '1 de agosto · nasce Herman Melville em Nova York (1819)',
    headline_en: 'August 1 · Herman Melville is born in New York (1819)',
    sub_pt: 'O criador de Moby Dick morreu esquecido em 1891 — a posteridade o ressuscitou.',
    sub_en: 'The creator of Moby Dick died forgotten in 1891 — posterity brought him back.',
  },
  {
    id: 'h4', kind: 'efemeride', accent: 'rose',
    headline_pt: '2 de agosto · nasce Isabel Allende em Lima (1942)',
    headline_en: 'August 2 · Isabel Allende is born in Lima (1942)',
    sub_pt: '"A Casa dos Espíritos" começou como carta ao avô moribundo — e virou uma das grandes sagas latino-americanas.',
    sub_en: '"The House of the Spirits" started as a letter to a dying grandfather and became one of Latin America\'s great sagas.',
  },
  {
    id: 'h5', kind: 'efemeride', accent: 'plum',
    headline_pt: '2 de agosto · nasce James Baldwin em Nova York (1924)',
    headline_en: 'August 2 · James Baldwin is born in New York (1924)',
    sub_pt: '"Giovanni\'s Room", "Se a Rua Beale Falasse" — uma voz insubstituível sobre amor, raça e liberdade.',
    sub_en: '"Giovanni\'s Room", "If Beale Street Could Talk" — an irreplaceable voice on love, race and freedom.',
  },
  {
    id: 'h6', kind: 'premio', accent: 'sage',
    headline_pt: 'Nobel de Literatura 2026: anúncio previsto para 8 de outubro',
    headline_en: 'Nobel Prize in Literature 2026: announcement set for October 8',
    sub_pt: 'A Academia Sueca revelará o laureado em Estocolmo. A espera começa.',
    sub_en: 'The Swedish Academy will name the laureate in Stockholm. The wait begins.',
  },
];
...
// ─────────────────────────────────────────────────────────────
// Atualizada semanalmente (rotina de segunda) — semana de 3 a 9 de agosto de 2026.
...
const CURADORIA = [
  { id: 'c1', kind: 'efemeride', date: '06 ago',
    title_pt: 'Jorge Amado morre há 25 anos — mas nunca saiu de cena',
    title_en: 'Jorge Amado died 25 years ago — and never left the stage',
    desc_pt: 'Falecido em Salvador em 6 de agosto de 2001, é o escritor brasileiro mais traduzido da história: presente em 49 idiomas, de japonês a búlgaro.',
    desc_en: 'Who died in Salvador on August 6, 2001, is Brazil\'s most translated writer ever — present in 49 languages, from Japanese to Bulgarian.' },
  { id: 'c2', kind: 'conexao', anchor_pt: 'conexão literária', anchor_en: 'literary connection',
    title_pt: 'Leu Melville? Leia Hemingway — e vice-versa',
    title_en: 'Read Melville? Try Hemingway — and vice versa',
    desc_pt: 'Dois escritores do mar: Melville levou 600 páginas para narrar a obsessão; Hemingway fez o mesmo em 130. Menos palavras, o mesmo silêncio imenso.',
    desc_en: 'Two writers of the sea: Melville needed 600 pages for obsession; Hemingway needed 130. Fewer words, the same vast silence.' },
  { id: 'c3', kind: 'contexto', anchor_pt: 'contexto literário', anchor_en: 'literary context',
    title_pt: 'Booker Prize 2026: o longlist e o estado da ficção em inglês',
    title_en: 'Booker Prize 2026: the longlist and the state of English fiction',
    desc_pt: '13 romances, 7 países, três continentes. Marlon James, Douglas Stuart e Elizabeth Strout voltam à disputa. Shortlist revelada em 22 de setembro.',
    desc_en: '13 novels, 7 countries, three continents. Marlon James, Douglas Stuart and Elizabeth Strout return to the race. Shortlist revealed on September 22.' },
  { id: 'c4', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: '"A Casa dos Espíritos" nasceu como carta ao avô',
    title_en: '"The House of the Spirits" was born as a letter to her grandfather',
    desc_pt: 'Allende começou a escrever em janeiro de 1981 para o avô centenário que estava morrendo no Chile. Não pensava publicar — pensava se despedir.',
    desc_en: 'Allende began writing in January 1981, to her hundred-year-old grandfather dying in Chile. She wasn\'t thinking of publishing — she was saying goodbye.' },
  { id: 'c5', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'Moby Dick foi inspirado numa baleia real',
    title_en: 'Moby Dick was inspired by a real whale',
    desc_pt: 'O cachalote "Mocha Dick" aterrorizou baleeiros no Pacífico no início do século XIX — branco, agressivo, indomável. Melville soube pelos relatos dos marinheiros.',
    desc_en: 'The sperm whale "Mocha Dick" terrorised whalers in the Pacific in the early 1800s — white, aggressive, untameable. Melville heard about it from sailors.' },
