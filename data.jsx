...
const HOJE_BANNER = [
  ...
  {
    id: 'h3', kind: 'citacao', accent: 'terra',
    headline_pt: '"Um livro deve ser o machado para o mar congelado dentro de nós."',
    headline_en: '"A book must be the axe for the frozen sea within us."',
    sub_pt: 'Franz Kafka',
    sub_en: 'Franz Kafka',
  },
  {
    id: 'h4', kind: 'premio', accent: 'ochre',
    headline_pt: 'Prêmio João do Rio: a crônica entra na Biblioteca Nacional',
    headline_en: 'João do Rio Prize: the chronicle joins the National Library',
    sub_pt: 'Nova categoria do prêmio a partir de 2026.',
    sub_en: 'A new award category from 2026.',
  },
  {
...
const CURADORIA = [
  { id: 'c1', kind: 'efemeride', date: '06 jun',
    title_pt: 'Nascimento de Thomas Mann (1875)',
    title_en: 'Birth of Thomas Mann (1875)',
    desc_pt: 'Autor de "A Montanha Mágica" e "Doutor Fausto".',
    desc_en: 'Author of "The Magic Mountain" and "Doctor Faustus".' },
  { id: 'c2', kind: 'efemeride', date: '03 jun',
    title_pt: 'Há 102 anos morria Franz Kafka (1924)',
    title_en: '102 years since Franz Kafka died (1924)',
    desc_pt: '"O Processo" e "A Metamorfose" seguem inesgotáveis.',
    desc_en: '"The Trial" and "The Metamorphosis" remain inexhaustible.' },
  { id: 'c3', kind: 'efemeride', date: '05 jun',
    title_pt: 'Federico García Lorca nasce em 1898',
    title_en: 'Federico García Lorca born in 1898',
    desc_pt: 'Poeta e dramaturgo de "A Casa de Bernarda Alba".',
    desc_en: 'Poet and playwright of "The House of Bernarda Alba".' },
  { id: 'c4', kind: 'premio', date: '13 mar',
    title_pt: 'Biblioteca Nacional cria o Prêmio João do Rio',
    title_en: 'National Library creates the João do Rio Prize',
    desc_pt: 'Nova categoria dedicada à crônica a partir de 2026.',
    desc_en: 'A new category dedicated to the chronicle from 2026.' },
  { id: 'c5', kind: 'lancamento', date: 'jun',
    title_pt: 'Biografia de Dercy Gonçalves, por Adriana Negreiros',
    title_en: 'Biography of Dercy Gonçalves, by Adriana Negreiros',
    desc_pt: 'A vida da humorista chega pela Objetiva.',
    desc_en: 'The comedian’s life, out now from Objetiva.' },
];
