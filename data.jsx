...
const FRASES_MARCANTES = [
  { pt: 'Caminhávamos sem nos procurar, mas sabendo que andávamos para nos encontrar.', en: 'We walked without searching for each other, but knowing we were walking to find each other.', autor: 'Julio Cortázar', obra: 'O Jogo do Amarelinho (Rayuela)' },
  { pt: 'Cinzenta, meu caro, é toda teoria; e verde é a árvore dourada da vida.', en: 'Grey, dear friend, is all theory, and green alone is life\'s golden tree.', autor: 'Goethe', obra: 'Fausto, Primeira Parte' },
  { pt: 'Contar histórias revela o sentido sem cometer o erro de defini-lo.', en: 'Storytelling reveals meaning without committing the error of defining it.', autor: 'Hannah Arendt', obra: 'Men in Dark Times' },
  { pt: 'Respirei fundo e ouvi o velho orgulho do meu coração: existo, existo, existo.', en: 'I took a deep breath and listened to the old brag of my heart: I am, I am, I am.', autor: 'Sylvia Plath', obra: 'The Bell Jar' },
  { pt: 'Tenha paciência com tudo o que não está resolvido em seu coração e tente amar as próprias questões como se fossem quartos fechados ou livros escritos numa língua estrangeira.', en: 'Be patient toward all that is unsolved in your heart and try to love the questions themselves as if they were locked rooms and books written in a very foreign language.', autor: 'Rainer Maria Rilke', obra: 'Cartas a um Jovem Poeta' },
  { pt: 'Um clássico é um livro que nunca terminou de dizer o que tinha para dizer.', en: 'A classic is a book that has never finished saying what it has to say.', autor: 'Italo Calvino', obra: 'Por Que Ler os Clássicos' },
  { pt: 'Tudo que não invento é falso.', en: 'Everything I do not invent is false.', autor: 'Manoel de Barros', obra: 'Memórias Inventadas' },
  { pt: 'A casa é o nosso canto do mundo.', en: 'Home is our corner of the world.', autor: 'Gaston Bachelard', obra: 'A Poética do Espaço' },
...
const HOJE_BANNER = [
  {
    id: 'h1', kind: 'efemeride', accent: 'plum',
    headline_pt: '24 de agosto · Borges nasce em Buenos Aires (1899)',
    headline_en: 'August 24 · Borges born in Buenos Aires (1899)',
    sub_pt: 'O criador de labirintos e bibliotecas — e o dia que, em sua homenagem, virou o Dia do Leitor na Argentina.',
    sub_en: 'The creator of labyrinths and libraries — the day that, in his honour, became Reader\'s Day in Argentina.',
  },
  {
    id: 'h2', kind: 'efemeride', accent: 'terra',
    headline_pt: '26 de agosto · Cortázar nasce em Bruxelas (1914)',
    headline_en: 'August 26 · Cortázar born in Brussels (1914)',
    sub_pt: '"Rayuela", "As Armas Secretas" — o inventor de uma prosa que explodiu o romance por dentro.',
    sub_en: '"Hopscotch", "Blow-Up" — the writer who exploded the novel form from within.',
  },
  {
    id: 'h3', kind: 'efemeride', accent: 'ochre',
    headline_pt: '28 de agosto · Goethe nasce em Frankfurt (1749)',
    headline_en: 'August 28 · Goethe born in Frankfurt (1749)',
    sub_pt: '277 anos do olimpiano de Weimar — "Fausto" e "Werther" ainda moldando o que chamamos de literatura.',
    sub_en: '277 years since the Olympian of Weimar — "Faust" and "Werther" still shaping what we call literature.',
  },
  {
    id: 'h4', kind: 'premio', accent: 'olive',
    headline_pt: 'Booker 2026 · shortlist revelada em 22 de setembro',
    headline_en: 'Booker 2026 · shortlist revealed on September 22',
    sub_pt: 'Dois ex-vencedores na longlist: Marlon James ("The Disappearers") e Douglas Stuart ("John of John"). Vencedor em 9 de novembro.',
    sub_en: 'Two former winners on the longlist: Marlon James ("The Disappearers") and Douglas Stuart ("John of John"). Winner announced November 9.',
  },
  {
    id: 'h5', kind: 'citacao', accent: 'rose',
    headline_pt: '"Cinzenta é toda teoria; verde é a árvore dourada da vida" — Goethe',
    headline_en: '"Grey is all theory; green is the golden tree of life" — Goethe',
    sub_pt: 'Do Fausto (1808) — Mefistófeles a um jovem estudante. Os livros não substituem o viver; ampliam o olhar para ele.',
    sub_en: 'From Faust (1808) — Mephistopheles to a young student. Books don\'t replace living; they deepen the gaze we turn toward it.',
  },
  {
    id: 'h6', kind: 'efemeride', accent: 'sage',
    headline_pt: '24 de agosto · Paulo Coelho faz 79 anos (1947)',
    headline_en: 'August 24 · Paulo Coelho turns 79 (1947)',
    sub_pt: '"O Alquimista" é o livro mais traduzido por um autor vivo — mais de 80 línguas, Guinness confirmado.',
    sub_en: '"The Alchemist" is the most translated book by a living author — over 80 languages, Guinness confirmed.',
  },
];
...
const CURADORIA = [
  { id: 'c1', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'Rayuela: o romance que se lê em três ordens diferentes',
    title_en: 'Hopscotch: the novel that can be read in three different orders',
    desc_pt: 'Cortázar publicou "O Jogo do Amarelinho" (1963) com dois índices. O primeiro linear, capítulos 1 a 56. O segundo embaralhado: 155 capítulos em sequência não convencional, com "capítulos prescindíveis" intercalados entre os essenciais. O leitor escolhe o percurso — e uma terceira leitura combina os dois. Nenhuma é canônica; todas são o livro. Cortázar nasce em 26 de agosto de 1914.',
    desc_en: 'Cortázar published "Hopscotch" (1963) with two tables of contents. The first is linear, chapters 1 to 56. The second is scrambled: 155 chapters in a non-conventional order, with "expendable chapters" woven among the essential ones. The reader chooses their path — and a third reading combines both. None is canonical; all of them are the book. Cortázar was born on August 26, 1914.' },
  { id: 'c2', kind: 'contexto', anchor_pt: 'contexto histórico', anchor_en: 'historical context',
    title_pt: 'O livro de Goethe que causou uma onda de suicídios na Europa',
    title_en: 'The Goethe novel that triggered a wave of suicides across Europe',
    desc_pt: '"Os Sofrimentos do Jovem Werther" (1774) transformou Goethe em celebridade e desencadeou o fenômeno que a psicologia hoje chama de "efeito Werther": jovens imitavam o protagonista na forma de morrer, com roupa similar e o livro aberto sobre a mesa. Alguns países chegaram a proibi-lo. O nome também batiza seu contrário — o "efeito Papageno", que usa a narrativa para prevenir suicídios. Goethe nasce em 28 de agosto de 1749.',
    desc_en: '"The Sorrows of Young Werther" (1774) made Goethe an overnight celebrity and sparked what psychology now calls the "Werther effect": young people across Europe imitated the protagonist\'s death — same clothes, the book left open on the table. Some countries banned it. The name also gives rise to its opposite — the "Papageno effect", where narrative is used to prevent suicides. Goethe was born on August 28, 1749.' },
  { id: 'c3', kind: 'conexao', anchor_pt: 'conexão literária', anchor_en: 'literary connection',
    title_pt: 'Leu Borges? Descubra Machado de Assis',
    title_en: 'Read Borges? Discover Machado de Assis',
    desc_pt: 'Dois mestres do narrador que desconfia de si mesmo. Em "Memórias Póstumas de Brás Cubas" (1881), Machado criou um defunto que conta a própria vida depois de morto — ironia e desconstrução antes de qualquer vanguarda existir. Borges nasceu em 1899, quando Machado ainda estava vivo; os dois se cruzaram no tempo por nove anos. Em ambos, a leveza da frase esconde um abismo de sentido.',
    desc_en: 'Two masters of the narrator who doubts himself. In "The Posthumous Memoirs of Brás Cubas" (1881), Machado created a dead man narrating his own life — irony and temporal deconstruction before any avant-garde existed. Borges was born in 1899, while Machado was still alive; nine years of overlap. In both, the lightness of the sentence hides an abyss of meaning.' },
  { id: 'c4', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'Cora Coralina publicou seu primeiro livro aos 75 anos',
    title_en: 'Cora Coralina published her first book at the age of 75',
    desc_pt: 'Ana Lins dos Guimarães Peixoto Brêtas nasceu em 20 de agosto de 1889 em Goiás Velho e escreveu durante décadas sem publicar. Em 1965, aos 75 anos, lançou "Poemas dos Becos de Goiás e Estórias Mais". Carlos Drummond de Andrade a saudou como "a maior poeta do Brasil". Ela morreu em 1985, aos 95 anos. A lição: nenhuma página escrita é perdida.',
    desc_en: 'Ana Lins dos Guimarães Peixoto Brêtas was born on August 20, 1889, in Goiás Velho and wrote for decades without publishing. In 1965, at age 75, she released "Poems of the Alleys of Goiás". Carlos Drummond de Andrade hailed her as "the greatest poet in Brazil". She died in 1985, aged 95. The lesson: no written page is ever lost.' },
  { id: 'c5', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'O Booker 2026 tem dois ex-vencedores na mesma corrida — e isso é raro',
    title_en: 'The 2026 Booker has two former winners in the same race — and that is rare',
    desc_pt: 'Marlon James venceu o Booker em 2015 com "A Brief History of Seven Killings"; Douglas Stuart, em 2020 com "Shuggie Bain". Em 2026 os dois retornam com novos romances na longlist. Ex-vencedores raramente reaparecem — o prêmio tende a lançar revelações, não confirmar consagrados. A shortlist sai em 22 de setembro; o vencedor em 9 de novembro.',
    desc_en: 'Marlon James won the Booker in 2015 with "A Brief History of Seven Killings"; Douglas Stuart in 2020 with "Shuggie Bain". In 2026 both return with new novels on the longlist. Former winners rarely reappear — the prize tends to launch new voices, not reaffirm the established. Shortlist on September 22; winner on November 9.' },
];
