...
const HOJE_BANNER = [
  {
    ...
    headline_pt: '17 de agosto · nasce Ted Hughes, Poeta Laureado britânico (1930)',
    headline_en: 'August 17 · birth of Ted Hughes, British Poet Laureate (1930)',
    sub_pt: '"Birthday Letters", "O Corvo" — uma das vozes mais poderosas do séc. XX.',
    sub_en: '"Birthday Letters", "Crow" — one of the 20th century\'s most powerful voices.',
  },
  {
    id: 'h2', kind: 'premio', accent: 'olive',
    headline_pt: 'Lídia Jorge vence o Prêmio Camões 2026',
    headline_en: 'Lídia Jorge wins the 2026 Camões Prize',
    sub_pt: 'A escritora portuguesa foi escolhida por unanimidade. "A Costa dos Murmúrios" é a porta de entrada.',
    sub_en: 'The Portuguese writer was chosen unanimously. "The Murmuring Coast" is the entry point.',
  },
  {
    id: 'h3', kind: 'premio', accent: 'ochre',
    headline_pt: 'Booker 2026 · longlist revelada — dois ex-vencedores concorrem',
    headline_en: 'Booker 2026 · longlist out — two former winners are nominated',
    sub_pt: 'Marlon James ("The Disappearers") e Douglas Stuart ("John of John"). Short list em 22 de setembro.',
    sub_en: 'Marlon James ("The Disappearers") and Douglas Stuart ("John of John"). Shortlist on September 22.',
  },
  {
    id: 'h4', kind: 'efemeride', accent: 'rose',
    headline_pt: '22 de agosto · nasce Dorothy Parker, voz mais cortante de Nova York (1893)',
    headline_en: 'August 22 · birth of Dorothy Parker, New York\'s sharpest voice (1893)',
    sub_pt: 'Poeta, contista e crítica — a rainha da Rodada do Algonquin e do humor negro americano.',
    sub_en: 'Poet, short story writer and critic — queen of the Algonquin Round Table and American dark wit.',
  },
  {
    id: 'h5', kind: 'adaptacao', accent: 'terra',
    headline_pt: '"The Dog Stars" de Peter Heller vira épico pós-apocalíptico de Ridley Scott',
    headline_en: '"The Dog Stars" by Peter Heller becomes a Ridley Scott post-apocalyptic epic',
    sub_pt: 'Com Jacob Elordi e Josh Brolin. "Ponto sem Retorno" estreia no Brasil em 27 de agosto.',
    sub_en: 'Starring Jacob Elordi and Josh Brolin. Opens in Brazil on August 27.',
  },
];
...
const CURADORIA = [
  { id: 'c1', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'Ted Hughes escreveu "Birthday Letters" em segredo durante 25 anos',
    title_en: 'Ted Hughes wrote "Birthday Letters" in secret for 25 years',
    desc_pt: 'Poemas endereçados a Sylvia Plath, sua esposa que morreu em 1963. Hughes os acumulou por décadas sem mostrar a ninguém. Em janeiro de 1998, com câncer diagnosticado, publicou os 88 poemas de uma vez — o livro tornou-se o mais vendido de poesia no Reino Unido naquele ano. Hughes morreu em outubro, nove meses depois.',
    desc_en: 'Poems addressed to Sylvia Plath, his wife who died in 1963. Hughes accumulated them over decades, showing them to no one. In January 1998, with cancer diagnosed, he published all 88 poems at once — the book became the UK\'s bestselling poetry title that year. Hughes died in October, nine months later.' },
  { id: 'c2', kind: 'contexto', anchor_pt: 'contexto literário', anchor_en: 'literary context',
    title_pt: 'Quem é Lídia Jorge — a escritora que venceu o Camões 2026',
    title_en: 'Who is Lídia Jorge — the writer who won the 2026 Camões Prize',
    desc_pt: 'Com 80 anos e décadas de obra, Lídia Jorge é uma das maiores vozes da prosa portuguesa contemporânea. "A Costa dos Murmúrios" (1988) mergulha na guerra colonial de Moçambique. "O Vento Assobiando nas Gruas" (2002) acompanha o regresso dos colonos. O júri do Camões votou por unanimidade — raro.',
    desc_en: 'At 80, with decades of work, Lídia Jorge is one of the greatest voices in contemporary Portuguese prose. "The Murmuring Coast" (1988) immerses in the Mozambican colonial war. "The Wind Whistling in the Cranes" (2002) follows the return of the colonists. The Camões jury voted unanimously — rare.' },
  { id: 'c3', kind: 'conexao', anchor_pt: 'conexão literária', anchor_en: 'literary connection',
    title_pt: 'Leu Borges? Descubra Silvina Ocampo',
    title_en: 'Read Borges? Discover Silvina Ocampo',
    desc_pt: 'Casada com Adolfo Bioy Casares e amiga íntima de Borges, Silvina Ocampo (1903–1993) ficou décadas à sombra dos dois. Seus contos são inconfundíveis: crianças cruéis, espelhos que mentem, mortes que chegam de lado. Mais sombria que Borges, mais estranha que Bioy — e, para muitos, mais perturbadora que os dois. Comece por "Autobiografía de Irene" (1948).',
    desc_en: 'Married to Adolfo Bioy Casares and an intimate friend of Borges, Silvina Ocampo (1903–1993) spent decades in their shadow. Her stories are unmistakable: cruel children, lying mirrors, deaths that arrive sideways. Darker than Borges, stranger than Bioy — and for many, more unsettling than both. Start with "Autobiografía de Irene" (1948).' },
  { id: 'c4', kind: 'curiosidade', anchor_pt: 'você sabia?', anchor_en: 'did you know?',
    title_pt: 'Dorothy Parker e a Rodada do Algonquin — o almoço que moldou o humor americano',
    title_en: 'Dorothy Parker and the Algonquin Round Table — the lunch that shaped American humour',
    desc_pt: 'A partir de 1919, um círculo de escritores, críticos e atores nova-iorquinos passou a almoçar diariamente no Hotel Algonquin. Parker era a voz mais afiada — e mais impiedosa, inclusive consigo mesma. O grupo durou uma década e definiu o tom da sátira cultural americana do séc. XX. Parker nascia em 22 de agosto de 1893.',
    desc_en: 'From 1919, a circle of New York writers, critics and actors lunched daily at the Algonquin Hotel. Parker was its sharpest — and most merciless — voice, including toward herself. The group lasted a decade and set the tone of 20th-century American cultural satire. Parker was born August 22, 1893.' },
  { id: 'c5', kind: 'conexao', anchor_pt: 'conexão literária', anchor_en: 'literary connection',
    title_pt: 'Leu "A Estrada" de McCarthy? Descubra "The Dog Stars" de Peter Heller',
    title_en: 'Read McCarthy\'s "The Road"? Discover Peter Heller\'s "The Dog Stars"',
    desc_pt: 'Dois romances sobre sobreviver ao fim do mundo. Em McCarthy, pai e filho cruzam uma América cinzenta; em Heller, um piloto e seu cachorro encontram um motivo para continuar. Mesmo registro — desespero que não cede ao desespero. O romance de Heller chega ao cinema em agosto de 2026, dirigido por Ridley Scott.',
    desc_en: 'Two novels about surviving the end of the world. In McCarthy, father and son cross a grey America; in Heller, a pilot and his dog find a reason to keep going. Same register — despair that refuses to yield to despair. Heller\'s novel reaches cinemas in August 2026, directed by Ridley Scott.' },
];
